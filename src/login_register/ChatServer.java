...
public class ChatServer implements ActionListener {
    ...
    ChatServer(){
        ...
        p1.setBackground(new Color(8,84,24));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/vide00.png"));
        ...
        ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icons/menn2.png"));
        ...
        JLabel name = new JLabel("Katlego");
        ...
        status.setBounds(110,36,100,22);
        ...
        send.setFont(new Font("SAN_SERID",Font.BOLD,16));
